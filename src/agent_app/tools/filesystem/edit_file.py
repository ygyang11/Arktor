...
EDIT_FILE_DESCRIPTION = (
    ...
    "(tabs/spaces) as it appears in the file; any surrounding context you pull into old_string "
    "must reappear in new_string, or it is deleted. Never include line number "
    "prefixes in old_string or new_string\n"
